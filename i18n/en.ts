...
export default {
    translation: {
        ...
        activityCardType: 'Activity Type',
        activityCardTypeRequired: 'Activity type is required',
        ...
        activityCriteriaHelp_lng: 'Longitude (Decimal Degrees)',
        activityCriteria_radius: 'Radius',
        activityCriteriaHelp_radius: 'Radius (Kilometer)',
        activityCriteria_nelat: 'North-East Latitude',
        activityCriteriaHelp_nelat: 'North-East Latitude (Decimal Degrees)',
        activityCriteria_nelng: 'North-East Longitude',
        activityCriteriaHelp_nelng: 'North-East Longitude (Decimal Degrees)',
        activityCriteria_swlat: 'South-West Latitude',
        activityCriteriaHelp_swlat: 'South-West Latitude (Decimal Degrees)',
        activityCriteria_swlng: 'South-West Longitude',
        activityCriteriaHelp_swlng: 'South-West Longitude (Decimal Degrees)',
